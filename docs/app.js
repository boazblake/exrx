  ...
  return {
    ...
    view: function view(_ref3) {
      ...
      return m(".contents", {
        ...
        id: mdl.state.route.id
      }, [m("h1.panel-title", mdl.state.route.title), m("section.panel", [m(".panel-body", mdl.clients.map(function (client) {
        return m(".panel-item.card", [m(".tile-icon", m("figure.avatar", {
